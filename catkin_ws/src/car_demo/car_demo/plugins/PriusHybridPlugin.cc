    ...
    : dataPtr(new PriusHybridPluginPrivate)
{
  ...
  ros::NodeHandle nh;
  this->dataPtr->controlSub = nh.subscribe("bolt", 10, &PriusHybridPlugin::OnPriusCommand, this);
...
void PriusHybridPlugin::OnPriusCommand(const bolt_msgs::Control::ConstPtr &msg)
{
  ...
  {
    case bolt_msgs::Control::NEUTRAL:
      this->dataPtr->directionState = PriusHybridPluginPrivate::NEUTRAL;
      break;
    case bolt_msgs::Control::FORWARD:
      this->dataPtr->directionState = PriusHybridPluginPrivate::FORWARD;
      break;
    case bolt_msgs::Control::REVERSE:
