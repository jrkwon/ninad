...
class NetModel:
    ...
    def _model(self):
        ...
        ###----------------------------------------------------------------###
            ...
            self.model = model_from_json(open('/home/ghor9797/NCD_Github/python/pretrained_weights/Transfer_Learning_ResNet_3/2019-04-29-20-07-40.json').read())
            ...
            self.model = Model(inputs=self.base_model, outputs=self.prediction)            
            '''
